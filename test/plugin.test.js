...
describe('plugin', function() {
  beforeEach(function() {
    this.check = sinon.stub(installer, 'check').callsFake(function(dep) {
      return dep;
    });
  ...
  describe('.apply', function() {
    ...
    it('should hook into `after-resolvers`', function() {
      ...
      expect(this.compiler.resolvers.loader.plugin.calls[0].arguments).to.equal(
        ['module', this.plugin.resolveLoader.bind(this.plugin)]
      );

      expect(this.compiler.resolvers.normal.plugin.calls.length).to.equal(1);
      expect(this.compiler.resolvers.normal.plugin.calls[0].arguments).to.equal(
        ['module', this.plugin.resolveModule.bind(this.plugin)]
      );
    });
  });
  ...
  describe('.preCompile', function() {
    beforeEach(function() {
      this.run = sinon
        .stub(webpack.Compiler.prototype, 'run')
  ...
  describe('.resolveExternal', function() {
    beforeEach(function() {
      this.resolve = sinon
        .stub(this.plugin, 'resolve')
        .callsFake(function(resolver, result, callback) {
          callback(
            new Error(
              util.format(
  ...
  describe('.resolveLoader', function() {
    it('should call .resolve', function() {
      ...
      this.compiler.resolvers.loader.resolve.callsFake(
  ...
  describe('.resolveModule', function() {
    ...
    it('should call .resolve if direct dependency', function() {
      ...
      this.compiler.resolvers.normal.resolve.callsFake(
        function(context, path, request, callback) {
